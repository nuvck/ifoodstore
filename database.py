...
CREATE TABLE IF NOT EXISTS bot_config(
    lara_name TEXT DEFAULT 'coloque um novo',                 -- Nome da lara
    lara_key TEXT DEFAULT 'coloque um novo',                                        -- Chave pix da lara
    bot_compra TEXT DEFAULT 'https://telegra.ph/file/f0ac7b4baf2ed34c51747.png',  -- Link da imagem do /comprar
    main_img TEXT DEFAULT 'https://telegra.ph/file/f0ac7b4baf2ed34c51747.png',  -- Link da imagem do /start
    support_user TEXT DEFAULT '@coloquenovo',                               -- Username de atendimento
    channel_user TEXT DEFAULT '@coloquenovo',                                    -- Canal de notícias
    ...
    pay_auto TEXT DEFAULT 'pagbank',                                            -- Seleção de pix auto
